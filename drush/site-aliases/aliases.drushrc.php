...
// Local environment.
$aliases['demo-config-split.local'] = array(
  'root' => '/var/www/demo-config-split/docroot',
  'uri' => 'http://local.demo-config-split.com',
  );
// Add remote connection options when alias is used outside VM.
if ('vagrant' != $_SERVER['USER']) {
  $aliases['demo-config-split.local'] += array(
    'remote-host' => 'local.demo-config-split.com',
    'remote-user' => 'vagrant',
